...
public class ManagerEquipment {
    ...
    public ManagerEquipment(String branch_id, String equipment_id, String description, String category, Date purchase_date, Date last_modified_date, Date next_maintenance_date) {
