...
public class FormMaintain {
     ...
     public FormMaintain(String form_id, String maintainer_id, String equipment_type, int no_of_maintainers, String description, String status, String branchmanager_id, String branch_id, Time re_time, Date re_date, String complet_dis, String complet_img, Date comp_date, Time comp_time) {
